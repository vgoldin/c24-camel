 ...
 */
package biz.c24.io.camel.c24io.old;

import java.util.List;

import biz.c24.io.camel.c24io.C24IOSource;
...
import static biz.c24.io.camel.c24io.C24IOTransform.transform;
        ...
        return new RouteBuilder() {
            public void configure() {
                from("file:src/test/data?noop=true").
                        ...
                        process(C24IOTransform.transform(StatGenTransform.class)).
